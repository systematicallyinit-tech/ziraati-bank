...
export async function POST(req) {
  ...
  try {
    ...
    let mailOptions = {
      ...
      to: `${user.email}`,
      subject: `NFT Purchase - ${process.env.NEXT_PUBLIC_COMPANY_NAME}`,
...
>
  ...
  <p
    ...
    "
  >
    A new deposit request has been submitted by ${user.full_name} and is currently under review by our finance team.
  </p>
  ...
  >
    ...
    return NextResponse.json({
      message: "NFT purchase request was successful!",
...
export async function GET(req) {
  try {
    ...
    const transactions = await Nft.find(filters);
